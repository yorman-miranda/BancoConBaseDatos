...
from typing import Generator
from dotenv import load_dotenv
from sqlalchemy import create_engine, text  # <-- Añadir text aquí
from sqlalchemy.orm import sessionmaker, Session
from contextlib import contextmanager
import logging
...
# Importar la Base única
from database.base import Base

# Importar todos los modelos para que SQLAlchemy los detecte
try:
    # Importar las entidades después de importar Base
    from entities.user import User
    from entities.cliente import Cliente
    from entities.cuenta import Cuenta
    from entities.empleado import Empleado
...
def check_connection():
    ...
    try:
        with engine.connect() as connection:
            # CORREGIDO: Usar text() para envolver la consulta SQL
